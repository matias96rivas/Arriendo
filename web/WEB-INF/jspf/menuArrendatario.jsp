<%-- 
    Document   : menuArrendatario
    Created on : 15-10-2018, 19:01:05
    Author     : Matias
--%>
...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
    ...
    <div class="w3-bar-block">
        ...
        <div class="w3-padding-32">
            <a href="../ServletCerrarSesion" class="w3-bar-item w3-button w3-padding"><i class="fa fa-close"></i>  Cerrar Sesion</a><br><br>
        </div>        
    </div>
</nav>
