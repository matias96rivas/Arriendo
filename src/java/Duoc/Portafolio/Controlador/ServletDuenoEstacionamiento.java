 ...
 * @author Dheler!
 */
@WebServlet(name = "ServletDuenoEstacionamiento", urlPatterns = {"/ServletDuenoEstacionamiento"})
public class ServletDuenoEstacionamiento extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (accion){
            case "listar":
                List<DuenoEstacionamiento> dueno = daoDueno.ListarDuenoEstacionamiento();
                if (dueno != null){
                  request.setAttribute("duenos", dueno);
                }else{
                    mensaje = daoDueno.getMensaje();
                }
                direccionar = "";
                break;
